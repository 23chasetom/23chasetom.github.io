...
layout: essay
type: essay
title: "Final Project Idea - ManoaNow"
date: 2025-11-04
labels:
...
# Mockup pages:
Landing Page – Introduces ManoaNow and highlights its purpose as a unified communication platform for UH Mānoa. Includes login and sign-up options for students, faculty, and verified clubs, as well as a brief tour of key features.
...
Admin Dashboard – Enables authorized administrators to oversee platform operations, manage user verification, review reported content, and maintain the overall integrity of the ManoaNow ecosystem.
Use cases ideas:
New User:
